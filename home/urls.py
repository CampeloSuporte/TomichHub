...
urlpatterns = [
    ...
    path('ferramentas/lg/irr/', views.lg_irr_filtro, name='lg_irr_filtro'),
    path('ferramentas/lg/as-set/', views.lg_as_set, name='lg_as_set'),
    ...
    path('ferramentas/geo/blocos/', views.geo_blocos_listar, name='geo_blocos_listar'),
    path('ferramentas/geo/blocos/salvar/', views.geo_blocos_salvar, name='geo_blocos_salvar'),
    path('ferramentas/geo/blocos/<int:bloco_id>/excluir/', views.geo_blocos_excluir, name='geo_blocos_excluir'),
