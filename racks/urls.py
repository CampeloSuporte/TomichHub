...
urlpatterns = [
    ...
    path('cliente/<int:cliente_id>/conexoes/religar/', views.api_link_religar, name='link_religar'),
    path('cliente/<int:cliente_id>/conexoes/sincronizar/', views.api_sincronizar, name='sincronizar'),
